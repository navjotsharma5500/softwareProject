        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/collection" className="hover:text-white transition-colors">Browse Items</Link></li>
              <li><Link to="/claimed" className="hover:text-white transition-colors">Claimed Items</Link></li>
