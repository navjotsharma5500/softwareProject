                  ...
                  <tbody className="divide-y divide-gray-200">
                    {items.map((item) => (
                      <tr key={item._id} className="hover:bg-gray-50">
                        <td className="px-4 py-3 text-sm font-mono">{item.itemId}</td>
                        ...
                        <td className="px-4 py-3 text-sm">{item.foundLocation}</td>
                        <td className="px-4 py-3 text-sm">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                          <div>
                            ...
                            <p className="text-sm text-gray-600">Roll: {claim.claimant?.rollNo}</p>
                          </div>
                          <div>
                            <span className="text-sm text-gray-500">Item Details:</span>
                            <p className="text-sm">Category: {CATEGORY_DISPLAY_NAMES[claim.item?.category]}</p>
                            <p className="text-sm">Location: {claim.item?.foundLocation}</p>
                            <p className="text-sm">
