      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="p-8">
            ...
            {/* Category */}
            <div className="mb-6">
              <div className="inline-block px-4 py-2 rounded-lg bg-indigo-50 text-indigo-700 font-medium">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-sm text-gray-500 mb-1">Found Location</div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-sm text-gray-500 mb-1">Date Found</div>
