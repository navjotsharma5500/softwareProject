      ...
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          ...
          <>
              ...
              {developers.map((dev, index) => (
                ...
                >
                  ...
                  <div className="pt-20 px-6 pb-6 flex flex-col h-full">
                    ...
                    <div className="mt-6">
                      <a
                        href={dev.portfolio ? dev.portfolio : dev.githubUrl}
                        target="_blank"
                      ...
                      >
                        <span className="inline-flex items-center">
                          {/* Use a generic user icon for portfolio, GitHub icon otherwise */}
                          {dev.portfolio ? (
            ...
            {/* Feedback Button - Shorter and Black */}
            <div className="mt-12 max-w-sm mx-auto">
              <a
                href="https://forms.gle/qxt4oppY6X163bgz9"
                target="_blank"
                rel="noopener noreferrer"
                className="flex justify-center items-center py-3 rounded-lg font-semibold transition-all duration-200 bg-gray-900 hover:bg-gray-800 text-white shadow-lg"
              >
                <span className="inline-flex items-center">
                  <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-4 max-w-sm mx-auto">
              <a
                href="https://github.com/navjotsharma5500/softwareProject"
                target="_blank"
                rel="noopener noreferrer"
                className="flex justify-center items-center py-3 rounded-lg font-semibold transition-all duration-200 bg-gray-900 hover:bg-gray-800 text-white shadow-lg"
              >
